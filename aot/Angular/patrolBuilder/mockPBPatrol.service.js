...
import { ActionCategory, ActionType, ActionScope, ActionDefinition, ParameterDefinition, } from '../patrols/action.class';
import { Injectable } from '@angular/core';
var MockPBPatrolService = /** @class */ (function (_super) {
    __extends(MockPBPatrolService, _super);
    function MockPBPatrolService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MockPBPatrolService.prototype.loadActionDefinitions = function () {
        ...
        for (var _i = 0, inputActDefs_1 = inputActDefs; _i < inputActDefs_1.length; _i++) {
            var item = inputActDefs_1[_i];
                ...
                if (item.Category) {
                    ...
                    switch (item.ActionType) {
                        case ActionType.Command: {
                            var cmdType = this.getCmdType(item);
                            if (cmdType.Type === 'command') {
                                ...
                                var cmdActionDef = this.getActDef(actCat, cmdType.DisplayName);
                                cmdActionDef.ActionScope = item.ActionScope;
                        ...
                        case ActionType.Orient: {
                            ...
                            for (var ii = 0; item.Parameters[0].Presets && ii < item.Parameters[0].Presets.length; ii++) {
                                ...
                                var preset = this.populatePreset(inputPreset);
    ...
    MockPBPatrolService = __decorate([
        Injectable()
    ], MockPBPatrolService);
    return MockPBPatrolService;
}(PatrolService));
export { MockPBPatrolService };
//# sourceMappingURL=mockPBPatrol.service.js.map