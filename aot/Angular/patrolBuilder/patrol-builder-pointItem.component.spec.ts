...
describe('Patrol Builder Point Item component', () => {
	let fixture: ComponentFixture<PatrolBuilderPointItem>;
	...
	it('Should create my PatrolBuilderPointItem component', () => {
		// Arrange
	...
	it('Should show point with start icon', () => {
		// Arrange
		fixture = TestBed.createComponent(PatrolBuilderPointItem);
		...
		fixture.whenStable().then(() => {
			let child = fixture.nativeElement.querySelector('.pointNameImg');
			if (child) {
	...
	it('Should show point with last icon', () => {
		// Arrange
		fixture = TestBed.createComponent(PatrolBuilderPointItem);
	...
	it('Should show checkpoint icon', () => {
		// Arrange
		fixture = TestBed.createComponent(PatrolBuilderPointItem);
	...
	it('Should show path point icon', () => {
		// Arrange
		fixture = TestBed.createComponent(PatrolBuilderPointItem);
	...
	it('Should get correct action command names', () => {
		// Arrange
		fixture = TestBed.createComponent(PatrolBuilderPointItem);
