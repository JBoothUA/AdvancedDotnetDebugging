...
describe('Patrol Builder Action Item component', function () {
    var fixture;
    beforeEach(async(function () {
        TestBed.configureTestingModule({
            imports: [FormsModule, HttpModule, PatrolModule, PatrolBuilderModule,
                SharedModule, BrowserAnimationsModule, RouterTestingModule, AlarmModule,
                MapModule
            ],
            providers: [
    ...
    it('Should create my PatrolBuilderActionItem component', function () {
        // Arrange
        fixture = TestBed.createComponent(PatrolBuilderActionItem);
        expect(fixture.componentInstance).toBeDefined();
    });
    it('Should set custom values correctly', function () {
        // Arrange
        fixture = TestBed.createComponent(PatrolBuilderActionItem);
        var action = testPatrol.Points[2].Actions[0];
        var patrolService = TestBed.get(PatrolService);
        var actionDef = patrolService.getActionDefinition(action);
        ...
        fixture.whenStable().then(function () {
            expect(fixture.componentInstance.isCustomValue).toBe(true);
            expect(fixture.componentInstance.isPresetValue).toBe(false);
            expect(fixture.componentInstance.customValue).toBe(action.Parameters[0].Value);
        });
    });
    it('Should set preset values correctly', function () {
        // Arrange
        fixture = TestBed.createComponent(PatrolBuilderActionItem);
        var action = testPatrol.Points[2].Actions[0];
        var patrolService = TestBed.get(PatrolService);
    ...
    it('Should contain all info for first action', function () {
        // Arrange
        fixture = TestBed.createComponent(PatrolBuilderActionItem);
        var action = testPatrol.Points[2].Actions[0];
        var patrolService = TestBed.get(PatrolService);
    ...
    it('Should contain all info for second action', function () {
        // Arrange
        fixture = TestBed.createComponent(PatrolBuilderActionItem);
        var action = testPatrol.Points[2].Actions[1];
        var patrolService = TestBed.get(PatrolService);
        var actionDef = patrolService.getActionDefinition(action);
        fixture.componentInstance.action = action;
        fixture.componentInstance.actionDef = actionDef;
...
//# sourceMappingURL=patrol-builder-actionItem.component.spec.js.map