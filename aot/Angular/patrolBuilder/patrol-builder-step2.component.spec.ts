...
describe('Patrol Builder Step 2 component', () => {
	let fixture: ComponentFixture<PatrolBuilderStep2>;
	...
	it('Show show points for patrol', () => {
		...
		let count: string = 'Patrol Points (' + testPatrol.Points.length.toString() + ')';
		expect(fixture.nativeElement.innerText).toContain(count);
	});

	it('Should add point to point list', () => {
		// Arrange
		fixture = TestBed.createComponent(PatrolBuilderStep2);
	...
	it('Should remove first point from list', () => {
		// Arrange
		fixture = TestBed.createComponent(PatrolBuilderStep2);
		let pbService: PatrolBuilderService = TestBed.get(PatrolBuilderService);
