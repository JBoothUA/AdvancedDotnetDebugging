...
describe('Alarm Table component', () => {
    let fixture: ComponentFixture<AlarmTable>;
	...
	it('should have a clickable linked description', () => {
		// Arrange
		...
		let alarmLink = fixture.nativeElement.querySelector('.clickable');

		// Assert
		expect(alarmLink.innerHTML).toEqual('Look at that Dog.');
	});

	it('should show the reported image for new alarms', () => {
		// Arrange
		fixture = TestBed.createComponent(AlarmTable);
		fixture.componentInstance.alarms = activeAlarms;
		...
		// Act
		fixture.detectChanges();
		let reportedImage = fixture.nativeElement.querySelector('img[alt="Reported"]');
		let ackdImage = fixture.nativeElement.querySelector('img[alt="Acknowledged"]');
	...
	it('should show the acknowledged image for ackd alarms', () => {
		// Arrange
		fixture = TestBed.createComponent(AlarmTable);
	...
	it('should show the color of the highest priority alarm', () => {
		// Arrange
		fixture = TestBed.createComponent(AlarmTable);
		...
		// Act
		fixture.detectChanges();
		let headerItemCount = fixture.nativeElement.querySelector('.group-header_ItemCount.p2');
