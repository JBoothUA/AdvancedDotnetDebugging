...
import { TenantLocation, SliderType } from './dashboard';
...
describe('Dashboard Slider Component', () => {
    let fixture: ComponentFixture<DashboardSlider>;
    ...
    it('should have tenant location data', () => { 
    ...
    it('should display first tenant location data', () => {
        // Arrange
        let locationService: LocationFilterService = TestBed.get(LocationFilterService);
        let alarmService: AlarmService = TestBed.get(AlarmService);
        alarmService.alarms = activeAlarms;
    ...
    it('should display all tenant location data', () => {
        // Arrange
        let locationService: LocationFilterService = TestBed.get(LocationFilterService);
        let alarmService: AlarmService = TestBed.get(AlarmService);
        alarmService.alarms = activeAlarms;
        ...
        let allTenants = dashboardService.getAllTenantLocations();
        let locationCount: number = 0;
        for (let t of allTenants) {
            locationCount += t.Locations.length;
        }
        for (let x = 0; x < locationCount; x++) {
            expect(fixture.nativeElement.innerText).toContain(custLocations[0].LocationName);
