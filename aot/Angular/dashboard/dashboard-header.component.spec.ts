...
describe('Dashboard Header Component', () => {
    ...
    it('should have location header text', () => {
        // Arrange
    ...
    it('should have alarm data', () => {
        ...
        // Assert
        let tab = $('#headerTabAlarmContent');
        expect(tab[0].innerText).toContain('Active Alarms');

        let count = $('#headerTabAlarmCount');
        expect(count[0].innerText).toContain('2');

        let p1 = $('#headerTabAlarmPriority-P1');
        expect(p1[0].innerText).toContain('1');

        let p2 = $('#headerTabAlarmPriority-P2');
        expect(p2[0].innerText).toContain('0');

        let p3 = $('#headerTabAlarmPriority-P3');
        expect(p3[0].innerText).toContain('0');

        let p4 = $('#headerTabAlarmPriority-P4');
