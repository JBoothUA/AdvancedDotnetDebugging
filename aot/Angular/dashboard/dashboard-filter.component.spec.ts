...
describe('Dashboard Filter Component', () => {
    ...
    it('should have current conditions selected', () => {
        // Arrange
        ...
        // Assert
        let header = fixture.nativeElement.querySelector('.filterTimeframeSelected');
        expect(header.innerText).toContain("Current Conditions");
    });

    it('should have last 8 hours selected', () => {
        // Arrange
        let alarmService: AlarmService = TestBed.get(AlarmService);
        alarmService.alarms = activeAlarms;
    ...
    it('should have last 12 hours selected', () => {
        // Arrange
        let alarmService: AlarmService = TestBed.get(AlarmService);
        alarmService.alarms = activeAlarms;
    ...
    it('should have last 24 hours selected', () => {
        // Arrange
        let alarmService: AlarmService = TestBed.get(AlarmService);
        alarmService.alarms = activeAlarms;
    ...
    it('should have last week selected', () => {
        // Arrange
        let alarmService: AlarmService = TestBed.get(AlarmService);
        alarmService.alarms = activeAlarms;
    ...
    it('should collaspe and reopen', () => {
        ...
        fixture.detectChanges();
        let collapse = $('#filterFunnelImageCollaspe');
        expect(collapse[0].innerHTML).toContain('gray');

        // Assert
        fixture.componentInstance.show = !fixture.componentInstance.show;
        fixture.detectChanges();
        let expanded = $('#filterFunnelImage');
