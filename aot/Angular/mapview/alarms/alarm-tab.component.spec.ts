...
describe('Alarm Tab component', () => {
    let fixture: ComponentFixture<AlarmTab>;
    ...
    it('should refresh the alarm list items every minute', () => {
		...
		let reportTime = fixture.componentInstance.alarmsContainer.nativeElement.querySelector('.lpAlarm_ReportedTimeCounter');
