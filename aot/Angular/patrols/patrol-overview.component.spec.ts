...
import { ActionInstance, ActionStatusValues } from '../patrols/action.class';

jasmine.DEFAULT_TIMEOUT_INTERVAL = 15000;

describe('Patrol overview component', () => {
    let fixture: ComponentFixture<PatrolOverview>;
...
let mockAction = new ActionInstance({
    "CurrentStatus": 0,
    "StatusHistory": null,
    "AlarmIds": null,
    "Image": null,
...
let mockPatrolInstance = new PatrolInstance({
